...
int main()
{
    ...
    sick f("76-665776", "Fedotov Vasiliy Viktorovich", 11, "jukova 24", "go developer");
    //std::cout << b;
    ...
    std::cout << a << std::endl;
    std::cout << a[sick::to_key("76-665774")] << std::endl;
    try
    {
        //a[sick::to_key("76-665773")];
        std::cout << a[sick::to_key("76-665773")] << std::endl;
    }
    catch(except &e)
    {
        std::cerr << e.what() << '\n';
